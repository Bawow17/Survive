...
local initialComponents = {
	...
	EnemyFreeze = true,
	EnemyLesserFlame = true,
	EnemyGreaterFlame = true,
	EnemyLesserPoison = true,
	EnemyGreaterPoison = true,
	EnemyBleed = true,
	EnemyExecuteThreshold = true,
	EnemyStun = true,
	EnemySlow = true,
...
function SyncSystem.init(worldRef: any, components: any, dirtyService: any, remotes: any, opts: any?)
	...
	componentLookup = {
		...
		HealthRegen = Components.HealthRegen,  -- Regen timing state for client UI
